...
$formNumber = '319';
    ...
    <main class="container">
        ...
        <form id="form3_19" action="/formato-evaluacion/store-form319" method="POST" data-teacher-email="{{ $teacherEmailFromUrl ?? '' }}" data-custom-url="true">
            ...
            <div style="display: flex; justify-content: space-between; padding-top: {{ $userType =='controlador' ? '80px' : '50px' }};">
                <div>
            ...
            <div style="display: flex; justify-content: space-between;padding-top: 150px;">
                <div>
                    <div id="convocatoria3" class="{{ $userType == 'dictaminador' ? 'dictaminador-style' : 'secretaria-style' }}">
                        @if(isset($convocatoria))
                            @if($userType == 'dictaminador')
                                <div style="margin-right: -700px;"><span style="font-size: 1.5em;">Convocatoria: {{ $convocatoria }}</span></div>
                            @elseif($userType =='controlador')
